...
# Dois painéis "Pesquisar por ameaçadas" e "Tutotiais"
...
# Se não há nomes no campo textAreaInput retorna uma data.frame vazio,
# se não, retorna um data.frame da função get.taxa do pacote flora
ifelse(
  length(nomes) == 0,
